...
sealed class ItemCreationState {
    ...
    data object TypeIsMandatoryError: ItemCreationState()
    data class Error(val exception: Exception): ItemCreationState() //RN-AC3: se debe seleccionar obligatoriamente un tipo
